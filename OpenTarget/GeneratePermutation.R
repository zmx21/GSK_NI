#Permutations of OpenTarget scores for calculation of Open Target empirical P-value
set.seed(2)
library(dplyr)
library(data.table)
library(hashmap)
...
#Generate permutations of open target scores
...
#For each individual gene and for each disease, calculate open target empirical p-value by generating permutations. 
