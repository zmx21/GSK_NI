...
print('Expr Mat Calculation')
load('../../Count_Data/CV_Filtered/MicrogliaTranscriptCVFiltered.rda')
exprMatCoding <- as.data.frame(t(MicrogliaTranscriptCVFiltered$coding))
exprMatAll <- as.data.frame(t(rbind(MicrogliaTranscriptCVFiltered$coding,MicrogliaTranscriptCVFiltered$noncoding)))
...
save(list = ls(environment()),file='../../CodeImages/WGCNA_Transcript.rda')
...
print('dynamic tree cut Calculation')
minModuleSize = 3
deepSplit = 2
...
print('writing clusters 2')
WriteGMT(moduleVector = modulesCodingUnsigned,
         rownames(adjacencyCoding),
         path = '../../WGCNA_clusters/Transcript_Level/CodingWGCNAUnsigned_Soft4_Size3_DeepSplit2.gmt',
         type = 'coding')
WriteGMT(moduleVector = modulesAllUnsigned,
         rownames(adjacencyAll),
         path = '../../WGCNA_clusters/Transcript_Level/AllWGCNAUnsigned_Soft4_Size3_DeepSplit2.gmt',
         type='all')

print('writing clusters 3')
minModuleSize = 3
deepSplit = 3
# Module identification using dynamic tree cut:
modulesCodingUnsigned = cutreeDynamic(dendro = geneTreeCodingUnsigned, distM = dissTOMCodingUnsigned,
...
WriteGMT(moduleVector = modulesCodingUnsigned,
         rownames(adjacencyCoding),
         path = '../../WGCNA_clusters/Transcript_Level/CodingWGCNAUnsigned_Soft4_Size3_DeepSplit3.gmt',
         type = 'coding')
WriteGMT(moduleVector = modulesAllUnsigned,
         rownames(adjacencyAll),
         path = '../../WGCNA_clusters/Transcript_Level/AllWGCNAUnsigned_Soft4_Size3_DeepSplit3.gmt',
         type='all')

print('writing clusters 4')
minModuleSize = 3
deepSplit = 4
# Module identification using dynamic tree cut:
modulesCodingUnsigned = cutreeDynamic(dendro = geneTreeCodingUnsigned, distM = dissTOMCodingUnsigned,
...
WriteGMT(moduleVector = modulesCodingUnsigned,
         rownames(adjacencyCoding),
         path = '../../WGCNA_clusters/Transcript_Level/CodingWGCNAUnsigned_Soft4_Size3_DeepSplit4.gmt',
         type = 'coding')
WriteGMT(moduleVector = modulesAllUnsigned,
         rownames(adjacencyAll),
         path = '../../WGCNA_clusters/Transcript_Level/AllWGCNAUnsigned_Soft4_Size3_DeepSplit4.gmt',
         type='all')
